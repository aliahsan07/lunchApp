...
(function () {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var q = window, t = document, ea = q.location, fa = function () {
    }, ha = /\[native code\]/, v = function (a, b, c) {
        return a[b] = a[b] || c
    }, ia = function (a) {
    ...
    var C = function (a, b, c) {
        ...
        ua = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"), va = /%([a-f]|[0-9a-fA-F][a-f])/g, wa = /^(https?|ftp|file|chrome-extension):$/i, D = function (a) {
            a = String(a);
            ...
            var c = [];
            if (a) for (var d in a) if (x(a, d) && null != a[d]) {
                var e = b ? b(a[d]) : a[d];
    ...
    var Qa = v(F, "perf", w()), Ra = v(Qa, "g", w()), Sa = v(Qa, "i", w());
    v(Qa, "r", []);
    w();
    w();
    ...
    var Wa = w(), H = [], J = function (a) {
        throw Error("Bad hint" + (a ? ": " + a : ""));
    };
    H.push(["jsl", function (a) {
        for (var b in a) if (x(a, b)) {
            var c = a[b];
            "object" == typeof c ? F[b] = v(F, b, []).concat(c) : v(F, b, c)
        }
        if (b = a.u) a = v(F, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/, Ya = [/\/amp\//, /\/amp$/, /^\/amp$/], Za = /^[a-zA-Z0-9\-_\.,!]+$/,
        $a = /^gapi\.loaded_[0-9]+$/, ab = /^[a-zA-Z0-9,._-]+$/, eb = function (a, b, c, d) {
            var e = a.split(";"), f = e.shift(), g = Wa[f], h = null;
            ...
            for (var b = a.substring(1).split("/"), c = []; b.length;) {
                a = b.shift();
                if (!a.length || 0 == a.indexOf(".")) J("empty/relative directory"); else if (0 < a.indexOf("=")) {
                    b.unshift(a);
                    break
                }
                c.push(a)
            ...
            e = ib(a, "rs");
            a = ib(a, "t");
            return {pathPrefix: b, version: c, L: d, T: e, V: a}
        }, gb = function (a) {
        ...
        ib = function (a, b, c) {
            ...
            return null
        }, db = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, cb = /\/cb=/g,
        bb = /\/\//g, jb = function () {
            var a = La(ea.href);
    ...
    var kb = decodeURI("%73cript"), lb = /^[-+_0-9\/A-Za-z]+={0,2}$/, mb = function (a, b) {
        ...
        if ("loading" != t.readyState) ob(a); else {
            var b = nb(), c = "";
            null !== b && (c = ' nonce="' +
                b + '"');
        ...
        if (e["::"] && b.length) {
            ...
            for (var f = null; f = b.shift();) {
                ...
                h && h.hint == g || (k = {hint: g, O: []}, a.push(k));
                k.O.push(f)
            }
            var l = a.length;
            if (1 < l) {
        ...
        h = v(Pa(c), "r", []).sort();
        var n = v(Pa(c), "L", []).sort(), r = [].concat(h), u = function (a, b) {
            if (p) return 0;
            q.clearTimeout(l);
            n.push.apply(n, y);
    ...
    var L = function (a) {
        ...
        if (b && "object" === typeof b) for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !ub(a[d]) && !ub(b[d]) ? N(a[d], b[d]) : b[d] && "object" ===
        ...
        M(!0);
        var b = window.___gcfg, c = L("cu"), d = window.___gu;
    ...
    var Fb = window.console, Gb = function (a) {
        Fb && Fb.log && Fb.log(a)
    };
    var Hb = function () {
        return !!F.oa
    ...
    var Mb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        Nb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//, Ob = function (a) {
    ...
    var Qb, Q, R = void 0, S = function (a) {
            try {
        ...
        }, Rb = T(0), Sb = T(new Date(0)), Tb = T(!0), Ub = T(""), Vb = T({}), Wb = T([]), U = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                if (null == a) b[b.length] = "null"; else if (e === Rb) a = Number(a), isNaN(a) || isNaN(a - a) ? a = "null" : -0 === a && 0 > 1 / a && (a = "-0"), b[b.length] = String(a); else if (e === Tb) b[b.length] = String(!!Number(a)); else {
        ...
        }, Xb = /[\0-\x07\x0b\x0e-\x1f]/, Yb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
        Zb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
        $b = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
        ac = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g,
        bc = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, cc = /[ \t\n\r]+/g,
        dc = /[^"]:/, ec = /""/g, fc = /true|false|null/g, gc = /00/, hc = /[\{]([^0\}]|0[^:])/,
        ic = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, jc = /[^\[,:][\[\{]/, kc = /^(\{|\}|\[|\]|,|:|0)+/, lc = /\u2028/g,
        mc = /\u2029/g, nc = function (a) {
            a = String(a);
    ...
    V.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.j, d = 0, e = this.F, f = this.o; d < b;) {
                if (0 == f) for (; d <= c;) uc(this, a, d), d += this.j;
    ...
    var wc = q.crypto, xc = !1, yc = 0, zc = 0, Ac = 1, Bc = 0, Cc = "", Dc = function (a) {
        a = a || q.event;
    ...
    var Qc = /^:[\w]+$/, Rc = /:([a-zA-Z_]+):/g, Sc = function () {
        ...
        var f = O("iframes/:socialhost:"), g = O("iframes/:im_socialhost:");
        return Lb = {
            socialhost: f,
    ...
    var Xc = {se: "0"}, Yc = {post: !0},
        Zc = {style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none"},
        $c = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        ad = v(F, "WI", w()), bd = function (a, b, c) {
            var d;
            var e = {};
            var f = d = a;
            ...
            f.exp = O(g + "exp");
            if (g = O(g + "location")) for (d = 0; d < g.length; d++) {
                var h = g[d];
                f[h] = q.location[h]
            }
            switch (a) {
            ...
            c._methods = p.join(",");
            return za(e, f, c)
        }, cd = ["style", "data-gapiscan"], ed = function (a) {
    ...
    var nd = function (a, b) {
        ...
        for (f = 0; f < e.length; f++) {
            ...
            var k = g;
            h = d;
            var l = k.nodeName.toLowerCase(), p = void 0;
        ...
        if (od(jd || {})) for (var y in c) {
            ...
            d = [];
            for (y in c) for (a = c[y], u = 0, b = a.length; u < b; u++) e = a[u], qd(y, e, ed(e), d, b);
            rd(r, d)
        }
    }, sd = function (a) {
        var b = v(B, a, {});
    ...
    var pd = function (a, b) {
        ...
        b && c ? (c(b), (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : B.load(a, function () {
            var c = Na(a), e = b && b.iframeNode, f = b && b.userParams;
    ...
    var Ad = /^\{h:'/, Bd = /^!_/, Cd = "", xd = function (a, b) {
        function c() {
        ...
        function d(d) {
            ...
            if (Dd(f, b)) {
                ...
                Ed(a, function () {
                    k && G("rqd");
                    c();
                    for (var a = v(F, "RPMQ", []), b = 0; b < a.length; b++) a[b]({data: f, origin: h})
                })
            }
        }
        ...
        if (d.s && a && -1 != ia.call(b, a)) {
            if ("_renderstart" === d.s || d.s === Cd + "/" + a + "::_renderstart") if (d = d.a && d.a[c ? 0 : 1], b = t.getElementById(a), Kb(a, 2), d && b && d.width && d.height) {
                a:{
                    c = b.parentNode;
                    a = d || {};
                    if (Hb()) {
    ...
    var Fd = function (a, b) {
        ...
        this.R = a.path;
        this.Z = !!a.secure
    }, Gd = /^[-+/_=.:|%&a-zA-Z0-9@]*$/, Hd = /^[A-Z_][A-Z0-9_]{0,63}$/;
    ...
    var Jd = "https:" === window.location.protocol, Kd = Jd || "http:" === window.location.protocol ? Fd : Id,
        Ld = function (a) {
    ...
    var Nd = function (a) {
        ...
        d = "E" === c && e.i;
        return !d && ("U" !== c || e.i) || d && !Jd ? b : {P: !0, i: d, ba: a.substr(1), domain: e.domain, l: e.l}
    }, Od = function (a) {
        if (!a) return [];
        a = a.split("=");
        ...
        if (null !== a) {
            ...
            if (c) {
                var d = Pd(c), e = d && d.aa[Number(a)];
                d = d && d.clientId;
                if (e) return {D: a, $: e, clientId: d}
            }
        }
        return null
    };
        ...
        K("auth", {
            callback: function () {
                ...
                a.checkSessionState(e, function (b) {
                    ...
                    yb("savedUserState", c);
                    (d || f) && Eb(b) && !O("disableRealtimeCallback") && a._pimf(b,
                        !0)
                })
            }
        });
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_GB.MtRp5wgSMps.O/am\u003dwQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPk5R7KPZo5MeRMxZllltIAgsb2iQ/m\u003d__features__",
            "u": "https://apis.google.com/js/platform.js",
            "hee": true,
            "fp": "b34029941a4dc51f623f17fa0d2230d93c157a61",
            "dpo": false
        },
